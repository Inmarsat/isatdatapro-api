...
function getWakeupDef(period) {
  return getKeyByValue(WakeupPeriods, period);
}
...
function getMtStateDef(state) {
  return getKeyByValue(ForwardMessageStates, state);
}
 ...
 * @param {ApiV1Auth} auth Mailbox authentication
 * @returns {Promise<BroadcastIdList>} See {@link BroadcastIdList} and {@link BroadcastInformation}
 */
