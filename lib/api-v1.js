 ...
 * @property {string} receiveTime An ISO timestamp YYYY-MM-DDTHH:MM:SSZ when the message was received at the Satellite Access Station
 ...
 * @property {string} mailboxTime An ISO timestamp YYYY-MM-DDTHH:MM:SSZ when the message is ready for retrieval in the Mailbox
 ...
 * @property {string} nextStartTime An ISO timestamp YYYY-MM-DDTHH:MM:SSZ for the next high water mark retrieval, empty string if none
 ...
 * @property {string} stateTime The ISO timestamp YYYY-MM-DDTHH:MM:SSZ of the last reported state of the message
 * @property {number} mobileWakeupPeriod A [something] indicating if the modem is configured for low power sleep
 * @property {string} scheduledSendTime An ISO timestamp YYYY-MM-DDTHH:MM:SSZ for the scheduled message delivery to a low power modem
 */
 ...
 * @property {string} stateTime The ISO timestamp YYYY-MM-DDTHH:MM:SSZ or Date of the reported state of the message
 ...
 * @property {(string|null)} nextStartTime The ISO timestamp YYYY-MM-DDTHH:MM:SSZ for the next retrieval, null if More is false
 ...
 * @property {string} stateTime The ISO timestamp YYYY-MM-DDTHH:MM:SSZ of the last reported state of the message
 * @property {number} mobileWakeupPeriod A [something] indicating if the modem is configured for low power sleep
 * @property {string} scheduledSendTime A timestamp YYYY-MM-DDTHH:MM:SSZ for the scheduled message delivery to a low power modem
 */
 ...
 * @property {string} lastRegistrationTime An ISO timestamp format YYYY-MM-DDTHH:MM:SSZ of the last Registration message
