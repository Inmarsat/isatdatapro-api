...
describe.only('#getMobileOriginatedMessages()', function () {
  ...
  it(description, function () {
    ...
    const filter = {
      startTimeUtc: date.toISOString().split('.')[0].replace('T', ' ')
    };
...
describe('#getMobileTerminatedStatuses(), #getMobileTerminatedMessages()', function () {
